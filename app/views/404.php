...
<head>
	<meta charset="UTF-8">
	<title>404 Not Found - Nggak Ketemu - Simulasi SNMPTN 2014 - SMA Negeri 2 Bandung</title>
	<style>
...
<body>
	<div class="welcome">
		...
		<h1>404 Not Found (Nggak Ketemu)</h1>
		<h2>Halaman yang dirimu cari nggak ada di sini.<br>Kamu tersesat? <a href="<?php echo URL::to('/'); ?>">Ke halaman depan yuk!</a></h2>
	</div>
