	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="alert alert-info">
				Ajaklah mereka yang belum log in di bawah ini untuk segera log in! Jika mereka lupa passwordnya, <b>kamu juga bisa mereset password mereka di menu Reset Password Siswa</b>.
			</div>
				...
				<tbody>
					...
					<tr class="{{ ( ( $siswa->verifikasi == 1 ) && ( count($siswa->pilihan) > 0 ) ) ? 'success' : 'danger' }}">
						...
						<td>
							...
							<a href="{{ URL::route('operator.batal', $siswa->id) }}" class="btn btn-xs btn-warning">Batalkan</a>
							@endif
						</td>
						<td>
